...
<br/>
<!--View Course-wise staff-->
<div class="container">
<h2 class="text-center text-primary">Course-wise Staff</h2>
<form action="admin_view_course_staff.jsp" method="post">
        <div class="row">
...
<table id="example" class="display table table-bordered table-responsive-sm" style="width:100%">
    ...
    Connection conn = DBConnection.getConnection();
                PreparedStatement ps = conn.prepareStatement("select * from faculty where course='"+course+"'");
