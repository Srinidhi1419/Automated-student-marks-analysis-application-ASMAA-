...
<html>
<head>
<title>View Deleted Staff</title>
...
<br/>
<!--View Deleted Staff-->
<h2 class="text-center text-primary">View Deleted Staff</h2>
...
PreparedStatement ps = conn.prepareStatement("select * from staff_delete");
