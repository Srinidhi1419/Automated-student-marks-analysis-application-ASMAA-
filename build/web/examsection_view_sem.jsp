...
<div class="col-12 jumbotron">
    <form action="examsection_view_sem.jsp" method="post">
    <div class="container">
        <h4>View Semester Marks</h4><hr>
<div class="row">
            <div class="col-sm-3">
                Course*
...
<div class="container">
<h2 class="text-center text-primary">Semester Marks</h2>
<table id="example" class="display" style="width:100%">
       ...
       System.out.println(course+" "+branch+" "+year+" "+sem);
                ...
                PreparedStatement ps = conn.prepareStatement("select * from semester where course='"+course+"' and branch='"+branch+"'  and year='"+year+"' and sem='"+sem+"'" );
