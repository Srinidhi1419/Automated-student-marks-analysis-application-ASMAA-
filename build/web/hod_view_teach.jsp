...
<table id="example" class="display table table-bordered table-responsive-sm" style="width:100%">
    ...
    Connection conn = DBConnection.getConnection();
                PreparedStatement ps = conn.prepareStatement("select * from faculty where dept='"+session.getAttribute("dept")+"'");
    ...
    %>
        <tbody>
            <tr>
                ...
                <td><a class="text-danger" href="hod_view_single_staff.jsp?empid=<%= rs.getString("empid")%>">View</a></td>
            </tr>
        </tbody><%}%>
    </table>
</div>
