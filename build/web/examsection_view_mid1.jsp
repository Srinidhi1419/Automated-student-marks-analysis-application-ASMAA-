...
<div class="col-12 jumbotron">
    <form action="examsection_view_mid1.jsp" method="post">
    <div class="container">
...
<div class="container">
<h2 class="text-center text-primary">Mid I Marks</h2>
<table id="example" class="display" style="width:100%">
       ...
       System.out.println(course+" "+branch+" "+year+" "+sem);
                ...
                PreparedStatement ps = conn.prepareStatement("select * from mid1 where course='"+course+"' and branch='"+branch+"' and year='"+year+"' and sem='"+sem+"'" );
