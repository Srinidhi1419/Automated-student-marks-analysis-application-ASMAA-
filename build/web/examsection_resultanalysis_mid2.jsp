...
<html>
<head>
<title>Mid II Result Analysis</title>
...
<h2 class="text-center text-primary">Mid II Result Analysis</h2>
<table id="example" class="display" style="width:100%">
       ...
       PreparedStatement ps=null;
              ...
              // ps = conn.prepareStatement("SELECT branch ,scode,sname ,COUNT(branch)as count FROM mid1 GROUP BY branch");
                ps = conn.prepareStatement("SELECT * FROM mid2 where scode like '"+regul+"%' and branch='"+branch+"' and year='"+year+"' and sem='"+sem+"'");
