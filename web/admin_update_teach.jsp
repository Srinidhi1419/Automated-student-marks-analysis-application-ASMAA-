...
<br/>
<form action="admin_update_teach.jsp" method="post">
        <div class="row">
...
<div class="container">
    ...
    %>
            <div class="col-sm-4">
                Employee ID*
                <input type="text" class="form-control" placeholder="" name="empid" value="<%= rs.getString("empid") %>" readonly=""><br/>
                Date of Birth*
                <input type="date" class="form-control" placeholder="" name="dob" value="<%= rs.getString("dob") %>">
                <br/>
                Contact Number*
                <input type="text" class="form-control" placeholder="" name="emno" value="<%= rs.getString("emno") %>">
                <br/>
                Email*
                <input type="email" class="form-control" placeholder="" name="email" value="<%= rs.getString("email") %>">
            </div>
            
            <div class="col-sm-4">
                Employee Name* (as per 10th Memo)
                <input type="text" class="form-control" placeholder="" name="ename" value="<%= rs.getString("ename") %>">
                    
                <br/>
                Aadhar Number*
                <input type="text" class="form-control" placeholder="" name="aadhar" value="<%= rs.getString("aadhar") %>">
                <br/>
                Gender*
                ...
                <br/>
                Date of Joining*
                <input type="date" class="form-control" placeholder="" name="doj" value="<%= rs.getString("doj") %>">                 
			</div>
        ...
        <thead>
            ...
            <tr>
                <td>1</td>
                <td><input type="text" class="form-control" name="reg1" value="<%= rs.getString("reg1") %>"></td>
                <td><input type="text" class="form-control" name="qual1" value="<%= rs.getString("qual1") %>"></td>
                <td><input type="text" class="form-control" name="inst1" value="<%= rs.getString("inst1") %>"></td>
                <td><input type="text" class="form-control" name="yop1" value="<%= rs.getString("yop1") %>"></td>
                <td><input type="text" class="form-control" name="marks1" value="<%= rs.getString("marks1") %>"></td>
            </tr>
            <tr>
                <td>2</td>
                <td><input type="text" class="form-control" name="reg2" value="<%= rs.getString("reg2") %>"></td>
                <td><input type="text" class="form-control" name="qual2" value="<%= rs.getString("qual2") %>"></td>
                <td><input type="text" class="form-control" name="inst2" value="<%= rs.getString("inst2") %>"></td>
                <td><input type="text" class="form-control" name="yop2" value="<%= rs.getString("yop2") %>"></td>
                <td><input type="text" class="form-control" name="marks2" value="<%= rs.getString("marks2") %>"></td>
            </tr>
            <tr>
                <td>3</td>
                <td><input type="text" class="form-control" name="reg3" value="<%= rs.getString("reg3") %>"></td>
                <td><input type="text" class="form-control" name="qual3" value="<%= rs.getString("qual3") %>"></td>
                <td><input type="text" class="form-control" name="inst3" value="<%= rs.getString("inst3") %>"></td>
                <td><input type="text" class="form-control" name="yop3" value="<%= rs.getString("yop3") %>"></td>
                <td><input type="text" class="form-control" name="marks3" value="<%= rs.getString("marks3") %>"></td>
            </tr>
            <tr>
                <td>4</td>
                <td><input type="text" class="form-control" name="reg4" value="<%= rs.getString("reg4") %>"></td>
                <td><input type="text" class="form-control" name="qual4" value="<%= rs.getString("qual4") %>"></td>
                <td><input type="text" class="form-control" name="inst4" value="<%= rs.getString("inst4") %>"></td>
                <td><input type="text" class="form-control" name="yop4" value="<%= rs.getString("yop4") %>"></td>
                <td><input type="text" class="form-control" name="marks4" value="<%= rs.getString("marks4") %>"></td>
            </tr>
            <tr>
                <td>5</td>
                <td><input type="text" class="form-control" name="reg5" value="<%= rs.getString("reg5") %>"></td>
                <td><input type="text" class="form-control" name="qual5" value="<%= rs.getString("qual5") %>"></td>
                <td><input type="text" class="form-control" name="inst5" value="<%= rs.getString("inst5") %>"></td>
                <td><input type="text" class="form-control" name="yop5" value="<%= rs.getString("yop5") %>"></td>
                <td><input type="text" class="form-control" name="marks5" value="<%= rs.getString("marks5") %>"></td>
            </tr>
        </table>
             <%}%>
        </div>
