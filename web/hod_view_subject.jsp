...
<div class="container">
<h2 class="text-center text-primary">View All Subjects</h2>
...
<table id="example" class="display table table-bordered table-responsive-sm" style="width:100%">
    ...
    Connection conn = DBConnection.getConnection();
                PreparedStatement ps = conn.prepareStatement("select * from subjects where dept='"+session.getAttribute("dept")+"' order by year asc");
    ...
    %>
        <tbody>
            <tr>
                ...
                <td><a href="DeleteSubject.jsp?scode=<%= rs.getString("scode") %>">Delete</a></td>
            </tr>
        </tbody><%}%>
    </table>
</div>
