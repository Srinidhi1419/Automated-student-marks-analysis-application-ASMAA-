...
<div class="container padding">
    <h2 class="col-12 register text-center">Add Student Details</h2>
...
<div class="container">
    <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                Aadhar Number*
                <input pattern="^[1-9]\d{11}$" class="form-control" placeholder="" name="aadhar" required="">
            </div>                        
        </div><br/>
        <div class="row">
            <div class="col-sm-6">
            ...
            <div class="col-sm-6">
                Occupation*
-                <input type="text" class="form-control" placeholder="" name="foccup" required="">
            </div>
            </div><br/>
        <div class="row">
            <div class="col-sm-6">
                Mother Name* (as per 10th Memo)
                <input type="text" class="form-control" placeholder="" name="mname" required="">
            </div>            
            <div class="col-sm-6">
                Occupation*
                <input type="text" class="form-control" placeholder="" name="moccup" required="">
            </div>   
        </div><br/>
        <div class="row">
                <div class="col-sm-6">                
        ...
        <div class="row">            
            <div class="col-sm-4">
                CET Rank*
                <input type="text" class="form-control" placeholder="" name="cet">
            </div>
            <div class="col-sm-4">
                Date of Birth*
        ...
        <div class="row">            
            <div class="col-sm-4">
                PRESENT ADDRESS*
                <textarea class="form-control" rows="5" id="comment" name="caddr" required=""></textarea>
            </div>
            <div class="col-sm-4">
                PERMANENT ADDRESS*
                <textarea class="form-control" rows="5" id="comment" name="paddr" required=""></textarea>
            </div>
            <div class="col-sm-4">
        ...
        <div class="row">
            <div class="col-sm-4">
                Student Cell Number*
                <input pattern="^[6-9]\d{9}$" class="form-control" placeholder="" name="smno" required="">
            </div>            
            <div class="col-sm-4">
                Parents Cell No*
                <input pattern="^[6-9]\d{9}$" class="form-control" placeholder="" name="pmno" required="">
            </div>
            <div class="col-sm-4">
                Parents Alternative Number*
                <input pattern="^[6-9]\d{9}$" class="form-control" placeholder="" name="plno">
            </div>           
        </div><br/>
        <div class="row">            
            <div class="col-sm-6">
                Student Email*
                <input type="email" class="form-control" placeholder="" name="semail" required="">
            </div>
            <div class="col-sm-6">
                Parent Email*
                <input type="email" class="form-control" placeholder="" name="pemail">
            </div>
    ...
    <div class="container">
        ...
        <thead>
            ...
            <tr>
                <td>2</td>
                <td>Intermediate or Diploma<input type="text" name="inter" value="Intermediate"></td>
                ...
                <td>3</td>
                <td>OTHER<input type="text" class="form-control" name="other"></td>
                <td><input type="text" class="form-control" name="inst3"></td>
                <td><input type="text" class="form-control" name="yop3"></td>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                ...
                <input type="text" class="form-control" placeholder="" name="htno" required="">
            </div>
            <div class="col-sm-4">
                Regulation* 
