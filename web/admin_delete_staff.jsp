...
<br/>
<!--Delete Staff-->
<h2 class="text-center text-primary">Delete Staff</h2>
<table id="example" class="display" style="width:100%">
        ...
        PreparedStatement ps = conn.prepareStatement("select empid,ename,dept from faculty union all select empid,ename,dept from nonfaculty;");
    ...
    %>
        <tbody>
            <tr><form action="delete_teachstaff_nonteachstaff.jsp" method="post">
                
                 <td><input type="hidden" name="empid" value="<%= rs.getString("empid")%>"/><%= rs.getString("empid")%></td>
