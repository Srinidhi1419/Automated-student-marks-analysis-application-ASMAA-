...
<html>
<head>
<title>View Deleted Students</title>
...
<div class="container">
<h2 class="text-center text-primary">Deleted Students</h2>
<table id="example" class="display table table-bordered table-responsive-sm" style="width:100%">
        ...
        PreparedStatement ps = conn.prepareStatement("select * from delete_student");
